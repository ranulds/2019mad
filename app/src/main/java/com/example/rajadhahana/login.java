                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild(name)) {
                            if (pw.equals(dataSnapshot.child(name).child("password").getValue().toString())) {
                                Invitation.setMyName(name);
                                User user = dataSnapshot.child(name).getValue(User.class);
                                Invitation.setMynumber(String.valueOf(user.getContactNo()));
                                System.out.println(Invitation.getMyName());
                                System.out.println(Invitation.getMynumber());
                                Intent intent4 = new Intent(login.this, Dashboard.class);
